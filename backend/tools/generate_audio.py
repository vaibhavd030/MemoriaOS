...
MOOD_CONFIGS: dict[str, dict] = {
    "calm": {
        "text": "<speak><prosody rate='slow' pitch='-2st'>Take a moment to breathe. Let the stillness surround you.</prosody></speak>",
        "voice": "en-GB-Wavenet-B",
        "speaking_rate": 0.8,
    },
    "energetic": {
        "text": "<speak><prosody rate='medium' pitch='+1st'>You have done something amazing today. Keep that energy going.</prosody></speak>",
        "voice": "en-GB-Wavenet-A",
        "speaking_rate": 1.1,
    },
    "peaceful": {
        "text": "<speak><prosody rate='slow' pitch='-1st'>The world is quiet now. Rest in this gentle moment.</prosody></speak>",
        "voice": "en-GB-Wavenet-F",
        "speaking_rate": 0.75,
    },
    "warm": {
        "text": "<speak><prosody rate='slow' pitch='low'>Sometimes the simplest moments hold the deepest meaning.</prosody></speak>",
...
async def generate_audio_summary(
    ...
    """Generate a mood-appropriate ambient audio clip using Cloud TTS and upload to GCS."""
